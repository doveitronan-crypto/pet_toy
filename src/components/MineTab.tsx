...
export default function MineTab({
  ...
  return (
    <div className="flex flex-col gap-6 text-left pb-10">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => onSetActivePet(pet)}
                    className={`text-xs font-bold px-3 py-1.5 rounded-lg transition-all ${
                      isActive
                        ? 'bg-brand-primary text-white pointer-events-none'
                        : 'bg-brand-bg text-brand-text-subtle hover:bg-brand-border/40'
                    }`}
                  >
                    {isActive ? '正在匹配' : '切换匹配'}
                  </button>
                ...
                >
                  <div className="flex items-center gap-3">
                    <img
                      ...
                      alt={item.toy.name}
                      className="w-10 h-10 rounded-lg object-cover border border-brand-border/60"
                      referrerPolicy="no-referrer"
                    />
                    <div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <ChevronRight className="w-4 h-4 text-brand-text-subtle/60" />
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* Main Gemini Behavioral Advisor Chatbot Room */}
